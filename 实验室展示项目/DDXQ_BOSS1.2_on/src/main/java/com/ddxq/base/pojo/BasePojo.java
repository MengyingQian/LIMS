...
public class BasePojo implements java.io.Serializable {
	...
	public long id;//唯一标识
	public String operationType;//操作类型（在OperationConstant类中进行查找使用或者添加）
	public String businessName;//属于哪个模块（在BusinessConstant类中进行查找使用或者添加，typeLevelOne为0或者1的时候，可为空）

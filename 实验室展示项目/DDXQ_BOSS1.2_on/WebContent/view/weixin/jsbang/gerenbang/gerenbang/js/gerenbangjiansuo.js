...
window.onload=function()
  {
	  ...
	  objmy.style.background = "url(../../../../../view/weixin/jsbang/gerenbang/gerenbang/img/jiantou_03.png) no-repeat 98% center";
	  ...
	  objmy.onclick=function()
	  {
		   ...
		   else
		   {
			  ...
			  objmy.style.background="url(../../../../../view/weixin/jsbang/gerenbang/gerenbang/img/jiantou_05.png) no-repeat 98% center";
			  objmy.style.backgroundSize='20px';
		   }
	  }

...
<head>
	...
	<script type="text/javascript">	
		$(function(){
			$("#districtId").textbox({ disabled: true});
			$("#districtId").textbox('setValue',$("#id").val());
			$("#dg").datagrid('options').url ='/ddxq/admin/weixinmanage/search?districtId='+$("#id").val();
	    	$("#dg").datagrid('reload');
		});
	function searchData(){
			var districtId=$("#districtId").val();
			$("#dg").datagrid('options').url ='/ddxq/admin/weixinmanage/search?districtId='+districtId;
	    	$("#dg").datagrid('reload');
		}
</script>
</head>
<body style="font-family: verdana, helvetica, arial, sans-serif;
	...
	<div id="tb" style="height:auto">
			...
			style="width: 50px"> 
		<a href="javascript:void(0);" onclick="searchData()"class="easyui-linkbutton" iconCls="icon-search">查询粉丝</a> 		

...
<body style="font-family: verdana, helvetica, arial, sans-serif;font-size: 0px;
    ...
    margin-right: 2px;
    margin-left: 2px;">
	<table id="dg" class="easyui-datagrid" title="小区管理员信息"  fit="true" border="true"
			data-options="
				iconCls: 'icon-edit',
				singleSelect: true,
				rownumbers:true,
	...
	<div id="tb" style="height:auto">		
		<select class="easyui-combobox"id="selectactor" disabled="disabled" label="选择员工类别:" style="width:25%"><option value="100" selected="selected">小区管理员</option></select>
...
<div id="dlg" class="easyui-dialog" title="添加小区管理员" data-options="iconCls:'icon-save'" style="width:450px;height: 350px;padding:5px">	
	...
	<script> 
		function submitEdit(){
			...
			$.ajax({
				url : '/ddxq/system/distman/editInfo',
				data : $.toJSON(retData),
				type : 'post',
				dataType : 'json',
				contentType : 'application/json',

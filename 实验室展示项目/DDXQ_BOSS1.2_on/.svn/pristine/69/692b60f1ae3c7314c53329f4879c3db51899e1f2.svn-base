...
<body style="font-family: verdana, helvetica, arial, sans-serif;
    ...
    <div style="padding:10%;">
	    <div class="easyui-panel" style="padding:100px;background:#fafafa;weight:50%;heigh:50%" data-options="fit:false,border:true" title="暂未开放"  >
	    	<div style=" text-align:center; font-family:微软雅黑,宋体;font-size:20px;">本栏目暂无信息。</div>
		</div>
	 </div>

package com.ddxq.system.employees.dao;
...
public class EmployeesDaoImpl implements EmployeesDao{
	...
	@Override
	public List<Map<String, Object>> getUserViaActorid(String districtId, String actorid) {
		String sql="select openId,created,updated,employeeId,passWD,employeeActor,districtId,employeeName,employeeNickName,employeeIdCard,employeeSex,employeeBirth,employeeMobile,employeeEmail,employeeProvince,employeeCity,employeeAddr,employeePostcode,employeeDepart,employeeSalary,employeeLevel,employeePoints,status,notes from ddxq_employees where employeeActor=? and districtId=?;";
		Object[] obj = new Object[]{actorid, districtId};
		List<Map<String, Object>> list=baseDAO.queryForList(sql,new Object[]{actorid, districtId});
		formDate(list);
		return list;
	}

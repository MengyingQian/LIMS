...
import com.ddxq.base.dal.strategy.IDynamicDataSource;
...
public class IdFactory implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		baseService = (BaseService) ap.getBean("baseService");
	...
	public void init() {
		...
		if (ip != null && port != null && Atlaststr != null) {
			...
			Map map = baseService.queryForIdInfo(ip + ":" + port);// 从数据库中获取对应服务器的ID生成策略

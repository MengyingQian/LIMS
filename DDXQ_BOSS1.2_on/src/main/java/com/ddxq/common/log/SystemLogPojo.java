...
import com.ddxq.common.constant.MongodbConstant;
import com.ddxq.base.pojo.BasePojo;
...
public class SystemLogPojo extends BasePojo {
	...
	private String modelName;//涉及到的业务模块名称
	private String operationType;//涉及到的操作类型

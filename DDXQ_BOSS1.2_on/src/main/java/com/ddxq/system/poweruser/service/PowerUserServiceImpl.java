...
public class PowerUserServiceImpl implements PowerUserService{
	...
	public JSONObject getUserViaActorid(String actorid) {
		...
		System.out.print(retJobj);
		return retJobj;
	}
	@Override
	public JSONObject getUserPosition(String actorid) {
		JSONObject retJobj = new JSONObject();
		List<Map<String, Object>> list=userDao.getUserPosition(actorid);
		retJobj.put("total",list.size());
		retJobj.put("rows", list);
		System.out.print(retJobj);
		return retJobj;
	...
	@Override
	public JSONObject getUserStatus(String actorid) {
		JSONObject retJobj = new JSONObject();
		List<Map<String, Object>> list=userDao.getUserStatus(actorid);
		retJobj.put("total",list.size());
		retJobj.put("rows", list);
		System.out.print(retJobj);
		return retJobj;

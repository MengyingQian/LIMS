...
<body class="easyui-layout" style="font-family: verdana, helvetica, arial, sans-serif;
    font-size: 0px;
    padding: 0px;
    margin: 8px;">
	<!-- begin of header -->
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
            ...
            <p><a href="ddxq/boss/loginManage/login">网站首页</a>|<a href="www.163.com">支持论坛</a>|<a href="www.bupt.edu.cn">帮助中心</a>|<a href="#">安全退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2016  丁丁小区  All Rights Reserved
    </div>
    <!-- end of footer -->  
